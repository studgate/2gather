...
CREATE TABLE `tbl_job_location` (
  ...
  CONSTRAINT `fk_tbl_job_location_2` FOREIGN KEY (`ID_location`) REFERENCES `tbl_locations` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_tbl_job_location_1` FOREIGN KEY (`ID_job`) REFERENCES `tbl_job` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_job_payment` (
  ...
  CONSTRAINT `fk_tbl_job_payment_1` FOREIGN KEY (`ID_job`) REFERENCES `tbl_job` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_tbl_job_payment_2` FOREIGN KEY (`ID_payment`) REFERENCES `tbl_payment` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_job_req` (
  ...
  CONSTRAINT `fk_tbl_job_req_1` FOREIGN KEY (`ID_job`) REFERENCES `tbl_job` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_tbl_job_req_2` FOREIGN KEY (`ID_req`) REFERENCES `tbl_requirements` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_job_skills` (
  `ID_job` bigint(20) NOT NULL,
  `ID_skils` bigint(20) NOT NULL,
  PRIMARY KEY (`ID_job`,`ID_skils`),
  KEY `fk_tbl_job_skills_2_idx` (`ID_skils`),
  CONSTRAINT `fk_tbl_job_skills_1` FOREIGN KEY (`ID_job`) REFERENCES `tbl_job` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_tbl_job_skills_2` FOREIGN KEY (`ID_skils`) REFERENCES `tbl_skills` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_payment` (
  `ID` bigint(20) NOT NULL,
  `Min_Amount` int(8) DEFAULT NULL,
  `Max_Amount` int(8) DEFAULT NULL,
...
CREATE TABLE `tbl_recruiter` (
  ...
  `LogoUrl` varchar(2083) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
